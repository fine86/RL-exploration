...
train_name = "[ver.1] 4 action 1 obstacle"
...
class exploreEnv(object):
    ...
    def observation(self):
        ...
        self.positive_reward += int(pow(observed_areas * 0.04, 2))
        self.negative_reward -= int(pow(observed_obstacles * 0.04, 2))
        ...
        if self.observable_area==0:
            ...
            self.negative_reward = -self.observable_area * 0.05
            self.done = True
